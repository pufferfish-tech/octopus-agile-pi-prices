...
- The sensitive data is stored in plain text in the file store_prices.py. This is in the form of a single API key as a string. If someone were able to access your pi, they could get this. The calls to get the data are done with https:// however. The security audit is up to you. Do the basics - change your pi password, don't open up your firewall to the pi (there's no need) and turn off UPNP in your router, etc. 
